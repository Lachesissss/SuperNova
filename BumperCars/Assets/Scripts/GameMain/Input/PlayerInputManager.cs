...
namespace Lachesis.GamePlay
{
    public class PlayerInputManager : GameModule
    {
        ...
        public bool UltimateP1 { get; private set; }
        public bool UltimateP2 { get; private set; }
        public bool UltimateP2J { get; private set; }
        ...
        private static InputSetting UltimateInputP1;
        private static InputSetting UltimateInputP2;
        private static InputSetting UltimateInputP2J;
        ...
        public void Initialize()
        {
            ...
            UltimateInputP1 = new InputSetting { Name = "Ultimate_P1", Invert = false , inputType = InputType.GetButtonDown};
            UltimateInputP2 = new InputSetting { Name = "Ultimate_P2", Invert = false , inputType = InputType.GetButtonDown};
            UltimateInputP2J = new InputSetting { Name = "Ultimate_P2_J", Invert = false , inputType = InputType.GetButtonDown};
        ...
        internal override void Update(float elapseSeconds, float realElapseSeconds)
        {
            if (enableInput)
            {
                ...
                UltimateP1 = GetInput(UltimateInputP1) >= 0.5f;
