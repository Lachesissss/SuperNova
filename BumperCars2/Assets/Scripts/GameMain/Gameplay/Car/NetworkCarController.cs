...
{
    public class NetworkCarController : NetworkEntity
    {
        public class NetworkCarControllerData
        {
            public NetworkCarComponent carComponent;
        ...
        public List<NetworkSkill> skillSlots;
        ...
        public override void OnInit(object userData = null)
        {
            ...
            skillSlots = new List<NetworkSkill>();
        ...
        public override void OnReCreateFromPool(Vector3 pos, Quaternion rot, object userData = null)
        {
            ...
            if (userData is NetworkCarControllerData data)
            {
        ...
        public void SetCar(NetworkCarComponent car)
        {
        ...
        public override void OnReturnToPool(bool isShutDown = false)
        {
            ...
            if (!isShutDown) StopAllCoroutines();
        ...
        {
            if (e is GetNetworkSkillEventArgs args)
                if (args.userName == controllerName)
                    for (var i = 0; i < skillSlots.Count; i++)
                        if (skillSlots[i] == null)
                        {
                            skillSlots[i] = GameEntry.NetworkSkillManager.CreateSkill(args.skillEnum);
                            GameEntry.EventManager.Invoke(this, PlayerSkillSlotsUIUpdateEventArgs.Create());
        ...
        public void ActivateSkill(int index)
        {
            ...
            {
                GameEntry.EventManager.Invoke(this, PlayerSkillSlotsUIUpdateEventArgs.Create());
                var config = GameEntry.NetworkSkillManager.GetSkillConfigItem(skillSlots[index].skillEnum);
        ...
        public void ClearCar()
        {
            if (carComponent != null)
            {
                ...
                GameEntry.NetworkEntityManager.ReturnNetworkEntity(carComponent.entityEnum, carComponent);
                carComponent = null;
            }
        }
