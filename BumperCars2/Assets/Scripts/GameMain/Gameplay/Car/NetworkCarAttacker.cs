...
namespace Lachesis.GamePlay
{
    public class NetworkCarAttacker : MonoBehaviour
    {
        ...
        public void Init(NetworkCarComponent ctrl, Rigidbody body)
        {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                var otherCar = otherRigidbody.GetComponent<NetworkCarComponent>();
                ...
                void OnHit()
                {
                    ...
                    otherRigidbody.velocity += (forceDirection.normalized * m_globalConfig.impactSpeed + rate * m_carBody.velocity) *
                                               (m_carBody.mass / otherRigidbody.mass);

                    // 暂时降低摩擦力
                    StartCoroutine(TemporarilyReduceFriction(otherWheelColliders, false));
